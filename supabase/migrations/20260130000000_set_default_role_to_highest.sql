-- Update handle_new_user_org to assign the highest roles ('owner' and 'admin') by default for the first user
...
BEGIN
  ...
  -- 4. Add user as OWNER (highest membership privilege)
  INSERT INTO public.organization_members (organization_id, user_id, role)
  VALUES (new_org_id, NEW.id, 'owner');

  -- 5. Add ADMIN user role (highest application control)
