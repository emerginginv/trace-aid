                ...
                <CardContent className="space-y-4">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                      <span className="text-sm">+{addon.storageGb >= 1000 ? `${addon.storageGb / 1000}TB` : `${addon.storageGb}GB`} additional storage</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                  ...
                  {hasAddon ? (
                    ...
                    >
                      ...
                      {!subscriptionStatus?.subscribed ? "Subscribe first" : "Add Storage"}
                    </Button>
                  )}
                </CardContent>
              </Card>
