...
const STEPS: StepInfo[] = [
  ...
  { step: 2, label: "Subjects", optional: true },
  { step: 3, label: "Updates", optional: true },
  { step: 4, label: "Events", optional: true },
  { step: 5, label: "Attachments", optional: true },
  { step: 6, label: "Review", optional: false },
];
