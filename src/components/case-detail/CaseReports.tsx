...
import { FileText, Eye, Clock, LayoutTemplate, FileType } from "lucide-react";
...
import { CaseDocuments } from "@/components/documents";
...
export function CaseReports({ caseId }: CaseReportsProps) {
  ...
  const fetchCaseVariables = async () => {
    const vars = await getCaseVariables(caseId);
    setCaseVariables(vars);
  };
  ...
  return (
    <Tabs defaultValue="reports" className="space-y-4">
      ...
      <TabsContent value="documents">
        {caseVariables ? (
          <CaseDocuments caseId={caseId} caseData={caseVariables} />
        ) : (
