...
import { FileText, Download, Clock, Plus, Trash2, Info } from "lucide-react";
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-md mb-4">
          ...
          Generated reports are stored here for future access and audit purposes.
        </p>
        {onGenerateReport && (
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip content="Previously generated reports are stored for audit purposes. Each report represents case data at the time of generation and is immutable." />
        </div>
        <div className="flex items-center gap-2">
      ...
      <p className="text-xs text-muted-foreground">
        Reports capture point-in-time snapshots. Generation events are permanently logged for audit trail preservation.
      </p>
            ...
            <TableRow>
              <TableHead>
                <span className="flex items-center gap-1">
                  Report Title
                  <DelayedTooltip content="Report name based on template and generation date">
              ...
              <TableHead>
                <span className="flex items-center gap-1">
                  Generated
                  <DelayedTooltip content="When this snapshot was created - data reflects this timestamp">
                    <Info className="h-3 w-3 text-muted-foreground" />
                  </DelayedTooltip>
                </span>
              </TableHead>
              <TableHead>
                <span className="flex items-center gap-1">
                  Generated By
                  <DelayedTooltip content="User who initiated report generation - logged for audit trail">
                    <Info className="h-3 w-3 text-muted-foreground" />
                  </DelayedTooltip>
                </span>
              </TableHead>
              ...
              <TableRow key={report.id}>
                ...
                <TableCell className="text-right">
                  <div className="flex items-center justify-end gap-1">
                    <DelayedTooltip content="Download the original generated file">
                      <Button
                        variant="ghost"
                        size="sm"
                    ...
                    <DelayedTooltip content="Remove from list. Note: Deletion is logged but does not affect external copies already downloaded.">
                      <Button
                        variant="ghost"
                        size="sm"
